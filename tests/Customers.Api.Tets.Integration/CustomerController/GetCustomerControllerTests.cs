...
namespace Customers.Api.Tets.Integration.CustomerController
{
    ...
    public class GetCustomerControllerTests// : IClassFixture<WebApplicationFactory<IApiMarker>>
    {
        ...
        [Fact]
        public async Task Get_ReturnsNotFound_WhenCustomerDoesNotExist() // Action_Retuns_When
        {
            // Arrange
            // Act
            ...
            //response.Headers.Location!.ToString().Should().Be("https://localhost/customers/");
        }
    }
}
